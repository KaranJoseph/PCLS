...
```{r echo=FALSE, fig.cap="Heavy Vehicles-Best Forecasting Model", fig.show="hold", fig.align="center"}
knitr::include_graphics("./Images/a.PNG")
```

```{r echo=FALSE, fig.cap="Medium Vehicles-Best Forecasting Model", fig.show="hold", fig.align="center"}
knitr::include_graphics("./Images/b.PNG")
```

```{r echo=FALSE, fig.cap="Small Vehicles-Best Forecasting Model", fig.show="hold", fig.align="center"}
knitr::include_graphics("./Images/c.PNG")
```

```{r echo=FALSE, fig.cap="Forecast Comaprison", fig.show="hold", fig.align="center"}
knitr::include_graphics("./Images/d.PNG")
```

## Inventory Management 
```{r echo=FALSE, fig.cap="Heavy Vehicles-RS Inventory Policy", fig.show="hold", fig.align="center"}
knitr::include_graphics("./Images/e.PNG")
```

```{r echo=FALSE, fig.cap="Heavy Vehicles-Silver Meals Heuristics", fig.show="hold", fig.align="center"}
knitr::include_graphics("./Images/f.PNG")
```

```{r echo=FALSE, fig.cap="Comparative Analysis-Inventory Policy", fig.show="hold", fig.align="center"}
